	...
	return (
		<Formik
			...
			onSubmit={(valores, {resetForm}) => { 
				...
				Axios.post("http://localhost:3001/api/insert",{marca_favorita, tiene_carro, num_puertas, lugar_carro, dia_carro, marca_poseida, cambiar_carro }).
		...
		{( {errors} /** importamos props de formik */ ) => (
					<Form className="formulario">
						...
						<div>
							<label htmlFor="tiene_carro">Tienes carro ? OwO</label>
                            <label>
